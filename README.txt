...
* 👥 **Spam Block Guarantee** – We are committed to helping you block spam. See the [Spam Block Guarantee](#-spam-block-guarantee---for-all-users) section.
...
Search for "Maspik" in your WordPress plugins section, click **Install**, and activate.

The plugin comes with smart pre-configured protection that works immediately. You can start blocking spam right away, without any technical configuration.  
If you need more advanced settings, please see the [documentation](https://wpmaspik.com/documentation/getting-started/?readme-file).
...
1. Install and activate Maspik
2. Go through the settings page
3. Enable the features that match your needs
...
[Report a security vulnerability.](https://patchstack.com/database/vdp/contact-forms-anti-spam)
...
1. Maspik main settings page for blocking spam in WordPress
2. Example configuration for blocking spam in contact forms
3. Advanced anti-spam settings page
4. Comment spam protection settings
5. WordPress spam protection overview
6. Blocking spam submissions in WordPress contact forms
...
* Improvement – Accessibility: aria-label and placeholder added for honeypot fields.
...
* Improvement – Refined dashboard integration UI: compact “Dashboard value” and “Dashboard rules” chips, improved status indicator, and masked display of sensitive API keys fetched from the Maspik Dashboard. 
* Improvement – Improved performance of Maspik Matrix, working better and more accurate - Active it from the Maspik settings page.
...
* Developer – Added hooks to disable spam check for specific forms: [Developer Hooks](https://wpmaspik.com/documentation/developers/?readme-file)
...
* Community – We want to grow and improve the experience:
  * Share your feedback and suggestions in our [Suggestion Box](https://wpmaspik.com/#suggestions?readme-file)
  * Give us a 5-star review on [WordPress.org](https://wordpress.org/support/plugin/contact-forms-anti-spam/reviews/#new-post)
...
* New feature – Added support for Custom PHP forms using the [filter](https://wpmaspik.com/documentation/custom-php-form/?readme-file)
...
= 2.4.0 - 30/01/2025 =
* Announcement – Improvements to reduce false positives. Read more in the [announcement post](https://wpmaspik.com/maspik-2-4-0-smarter-spam-blocking-fewer-false-positives/?readme-file)
* Improvement – Text and textarea blacklists now match exact words only, preventing false positives from partial matches
* Improvement – Email blacklist check now supports exact match or "contains" logic (for example, "seo" will block "seoexpert@gmail.com")
